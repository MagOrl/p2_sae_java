...
public class MenuGererStocksGlobaux extends BorderPane {
    ...
    public MenuGererStocksGlobaux(AppliLib app, Administrateur admin) {
        ...
        this.choixLibrairie.valueProperty()
                .addListener(new ControleurChoixLibrairie(librairieActuelle, this, this.modele));
        ...
        this.critereReherche.valueProperty()
                .addListener(new ControleurCritereRecherche(this.critereActuel, this, this.modele));
        ...
        this.btRetour.setStyle(AppliLib.styleBouton + "-fx-background-color:rgb(194, 60, 60);");
    ...
    public VBox left() {
        ...
        this.btAjouterLivre.disableProperty()
                .bind(isbn.textProperty().isEmpty()
                        .or(datePubli.textProperty().isEmpty().or(nbPages.textProperty().isEmpty().or(qte.textProperty()
                                .isEmpty().or(prix.textProperty().isEmpty().or(titre.textProperty().isEmpty()))))));
    ...
    public Alert popUpQteInfAZero() {
        Alert alert = new Alert(Alert.AlertType.ERROR,
                "La nouvelle quantité est inférieure à zéro, veuillez enlever moins de quantitié");
        return alert;
    }

    public Alert popUpLivreInexistant() {
        Alert alert = new Alert(Alert.AlertType.ERROR,
                "Le livre dont vous essayez de mettre à jour la quantité n'xiste pas dans la base de donnée");
        return alert;
    }
